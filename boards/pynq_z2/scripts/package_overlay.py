    ...
    readme.write_text(
        "\n".join(
            [
                ...
                "      --ebn0 1.0 1.5 2.0 2.5 3.0 --frames 200 --max-frame-errors 60 \\",
                "      --output results/hardware/ber_fer.jsonl",
                "  XILINX_XRT=/usr /usr/local/share/pynq-venv/bin/python3 benchmark.py throughput \\",
                "      --frames 500 --noiseless --output results/hardware/throughput.json",
                "",
